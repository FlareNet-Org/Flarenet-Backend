...
console.log('webHookQueue: Redis environment loaded from:', redisCloudPath);
console.log('webHookQueue: Redis URL from env:', process.env.REDIS_URL ? 'YES (defined)' : 'NO (undefined)');

...
console.log('buildQueue: Redis environment loaded from:', redisCloudPath);
console.log('buildQueue: Redis URL from env:', process.env.REDIS_URL ? 'YES (defined)' : 'NO (undefined)');
